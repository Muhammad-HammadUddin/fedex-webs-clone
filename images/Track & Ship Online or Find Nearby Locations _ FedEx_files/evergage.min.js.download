...
(function configureEvergage() {
    try {
       Evergage.configure({
           ...
           siteConfigVersion: "7"
       },{"allowBotTraffic":false,"corsAllowedOrigins":["*"],"defaultCurrency":"USD","defaultLocale":null,"disableQtipWindowScroll":false,"doNotStoreCookiesRequireProvidedAnonId":false,"doNotTrackPingRequestsForActions":false,"enableCorsRestrictedOrigins":false,"enableMessageRotation":false,"enableRememberMeUserIds":false,"enableTemplateEsc":false,"hideContentSections":false,"hideContentSectionsMillis":2500,"hidePagesForRedirect":false,"hidePagesForRedirectMillis":1000,"identityAttributes":["UUID","customerId","emailAddress","profileId","sfmcContactKey"],"lastModified":1696950606262,"preventSensitiveDataCapture":false,"rememberMeUserIdsMillis":63072000000,"secureCookie":true,"sendErrorEvents":true,"showPoweredBy":false,"siteConfigExecBeforePageReady":false,"spaRouteChangeTimeout":500,"trackAnonymousVisitors":true,"trackContextualRelatedItems":false,"trackSubdomainAsCompany":false,"trackUnknownPagesByTitle":false,"treatHashChangeAsPageLoad":false}       );
    } catch (e) {
          console.error(e);
    }
})();
            ...
            function pageMatch(pagePathCheck1,pagePathCheck2,pagePathCheck3) {
              return new Promise((resolve, reject) => {
               ...
               // console.log('Begin Page Match Promise')
                ...
                const pagePath1 = events?.reverse().find(event => event.event.name === "pageview")?.page.pagePath1;
                const pagePath2 = events?.reverse().find(event => event.event.name === "pageview")?.page.pagePath2;
   ...
   let config = {
                global: {
                    ...
                    onActionEvent: (actionEvent) => {
                        let gdlUserObject = window?.gdl?.params?.user
                        if (gdlUserObject) {
                        ...
                        let gdlClientObject = window?.gdl?.params?.clientIds
                        if (gdlClientObject) {
            ...
            config.pageTypes.push({
                ...
                listeners: [
                    SalesforceInteractions.listener('click', '[data-analytics="link|Get a rate"]', (e) => {
                        SalesforceInteractions.sendEvent({
                          interaction: {
                    ...
                    SalesforceInteractions.listener('click', '[data-analytics="foc|How to Ship Internationally"]', (e) => {
                        SalesforceInteractions.sendEvent({
                          interaction: {
                    ...
                    SalesforceInteractions.listener('click', 'a[href="https://www.fedex.com/GTM"]', (e) => {
                        SalesforceInteractions.sendEvent({
                          interaction: {
                            name: 'Clicked Global Trade Manager'
                          }
                    ...
                    SalesforceInteractions.listener('click', 'a[href="https://www.fedex.com/en-us/shipping/electronic-export-information.html"]', (e) => {
                        SalesforceInteractions.sendEvent({
                          interaction: {
                    ...
                    SalesforceInteractions.listener('click', 'a[href="https://www.fedex.com/en-us/shipping/international/brokerage.html"]', (e) => {
                        SalesforceInteractions.sendEvent({
                          interaction: {
                    ...
                    SalesforceInteractions.listener('click', 'a[href="https://internationalshippingassist.van.fedex.com/"]', (e) => {
                        SalesforceInteractions.sendEvent({
                          interaction: {
